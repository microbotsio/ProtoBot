...
private:
  ...
  uint16_t _prox_last = 0, _eyelight_off_value = 0, _proximity_stable = 0, _eyelight_change = 0, _block_proxmity_last = 0, _block_light_light_last = 0, _driver_timer = 0, _advertise_timer = 0, _reverse_counter = 0, _drive_counter = 0, _prox_thr = 0, _proximity_last = 0, _send_timer = 0, _send_thr = 10, _squish_timer = 0, _proximity = 0, _drive_speed = 0, _shape_timer = 0, _motor1_speed = 0U, _motor2_speed = 0U;
