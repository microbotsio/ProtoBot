...
private:
  ...
  bool _Front_Flag=0, _frontspin = 0, _FrontAvoidOnOFF_Flag = 0, _spin_flag = 0, _eyelight_dir = 0, _orientation_flag = 0, _balance_mode = 0, _line_side = 0, _line_revdir = 0, _blockTouchGesture = 0, _motor1_dir = 0, _motor2_dir = 0, _motor1_dir_last = 0, _motor2_dir_last = 0, _motor_off = 0, _proximity_flag = 0, _lowbat_tone = 0;
  uint8_t  _motion_timer = 0, _Front_timer =0, _m1_speed, _m2_speed, _frontavoid_timer = 0, _run_timer = 0, _miss_counter = 0, _line_hit = 0, _line_miss = 0, _turn_timer = 0, _mode = 0, _angle_done = 0, _shape_index = 0, _block_shape_counter = 0, _init_timer = 0, _proximity_timer = 0, _motionoff_last = 0, _infinity_phase = 0, _bot_status = 0, _shape_done = 0, _voltage_last = 100, _prox_index = 0;
  uint16_t _driver_timer = 0, _advertise_timer = 0, _line_darkness = 0, _line_angle = 0, _reverse_counter = 0, _drive_counter = 0, _prox_thr = 0, _proximity_last = 0, _send_timer = 0, _send_thr = 10, _squish_timer = 0, _proximity = 0, _drive_speed = 0, _shape_timer = 0, _motor1_speed = 0U, _motor2_speed = 0U;
  uint32_t _eyelight_value = 0, _eyelight_proximity = 0, _eyelight_proximity_last = 0, _Front_proximity=0;
