...
#define WINDUP_MAX 10000.0   // Maximum value for _integral term
#define WINDUP_MIN -10000.0  // Minimum value for _integral term
...
private:
  ...
  bool _FrontAvoidClear = 0, _eyelight_dir = 0, _orientation_flag = 0, _balance_mode = 0, _line_side = 0, _line_revdir = 0, _blockTouchGesture = 0, _motor1_dir = 0, _motor2_dir = 0, _motor1_dir_last = 0, _motor2_dir_last = 0, _motor_off = 0, _proximity_flag = 0, _lowbat_tone = 0;
